...
const largeEmptyWidget = SizedBox.expand();

const horizontalMargin1 = SizedBox(width: 1);
...
const verticalMargin1 = SizedBox(height: 1);
const verticalMargin2 = SizedBox(height: 2);
...
const horizontalPadding1 = EdgeInsets.symmetric(horizontal: 1);
...
const verticalPadding1 = EdgeInsets.symmetric(vertical: 1);
...
const leftPadding1 = EdgeInsets.only(left: 1);
...
const rightPadding1 = EdgeInsets.only(right: 1);
